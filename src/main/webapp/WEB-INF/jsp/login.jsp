...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <div><a class="navbar-brand" href="index.html" style="font-size:32px;">好筹网-创意产品众筹平台</a></div>
        </div>
    </div>
</nav>
...
<div class="container">
    ...
    <form id="loginForm" action="doLogin" method="post" class="form-signin" role="form">
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" id="loginattc" name="loginattc" placeholder="请输入登录账号" autofocus>
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.success) {
                    ...
                    layer.msg("用户信息错误，请重新输入", {time: 2000, icon: 5, shift: 6}, function () {
