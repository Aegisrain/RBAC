...
<script type="text/javascript">
    ...
    function goAssignPage(id) {
        window.location.href = "${APP_PATH}/user/assgin?id=" + id;
    }
    ...
    function deleteUser(id, loginattc) {
        layer.confirm("删除用户信息【" + loginattc + "】，是否继续？", {icon: 3, title: '提示'}, function (cindex) {
            //删除用户信息
            $.ajax({
                type: "POST",
